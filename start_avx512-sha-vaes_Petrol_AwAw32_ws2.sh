...
./graftcp/graftcp ./avx512-sha-vaes -a gr -o stratum+tcps://na-rtm.pool-server.com:5555 -u RESAxxraKQfvCo16GjzmGFXUd6BqLdADqn.PetrolAwAw8 -p IhatePopUps --no-tune
